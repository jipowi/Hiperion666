...
public class GarantiaAduaneraBacking implements Serializable {
	 ...
	 * <p>
	 * [Author: Avila Sistemas, Date: 05/04/2016]
	 * </p>
	 * 
		...
		try {
			...
			if (!identificacion.equals("") && ValidatorCedula.getInstancia().validateCedula(identificacion)) {
				...
				if (cliente == null) {
					...
					ramoGarantiaAduaneraBean.setNombreCliente(cliente.getNombrePersona() + " " + cliente.getApellidoPaterno() + " "
	...
	public void buscarContactoAseguradora() {
		...
		buscarContactoAseguradora(ramoGarantiaAduaneraBean.getAseguradora());
	}
	...
	public void addAseguradora() {
		...
		try {
			Long idAseguradora = Long.parseLong(ramoGarantiaAduaneraBean.getAseguradora());
			Aseguradora aseguradoraNew = aseguradoraService.consultarAseguradoraByCodigo(ramoGarantiaAduaneraBean.getAseguradora());
			...
			AseguradoraDTO aseguradoraDTO = new AseguradoraDTO(detalleCatalogo.getDescDetCatalogo(), aseguradoraNew.getDirecion(),
					...
					ramoGarantiaAduaneraBean.getContactoAseguradora());
	...
	/**
	 * 
	 * <b> Redobde los calculos de prima neta </b>
	 * <p>
	...
	public Poliza setearDatosPoliza() {
		...
		poliza.setRamo(RamoEnum.R13.getLabel());
	...
	public static void setAseguradorasDTO(List<AseguradoraDTO> aseguradorasDTO) {
		GarantiaAduaneraBacking.aseguradorasDTO = aseguradorasDTO;
	}
