...
public class BuenaCalidadMaterialesBacking implements Serializable {
	 ...
	 * <p>
	 * [Author: Franklin Pozo B, Date: 16/03/2016]
	 * </p>
	 * 
		...
		try {
			...
			if (!identificacion.equals("") && ValidatorCedula.getInstancia().validateCedula(identificacion)) {
				...
				if (cliente == null) {
					...
					ramoBuenaCalMatBean.setNombreCliente(cliente.getNombrePersona() + " " + cliente.getApellidoPaterno() + " "
	...
	public void buscarContactoAseguradora() {
		...
		buscarContactoAseguradora(ramoBuenaCalMatBean.getAseguradora());
	}
	...
	public void addAseguradora() {
		...
		try {
			Long idAseguradora = Long.parseLong(ramoBuenaCalMatBean.getAseguradora());
			Aseguradora aseguradoraNew = aseguradoraService.consultarAseguradoraByCodigo(ramoBuenaCalMatBean.getAseguradora());
			...
			AseguradoraDTO aseguradoraDTO = new AseguradoraDTO(detalleCatalogo.getDescDetCatalogo(), aseguradoraNew.getDirecion(),
					...
					ramoBuenaCalMatBean.getContactoAseguradora());
	...
	/**
	 * 
	 * <b> ermite obtener el numero de dias de cobertura </b>
	 * <p>
	 * [Author: Franklin Pozo B, Date: 16/03/2016]
	 * </p>
	 * 
	...
	public static void setAseguradorasDTO(List<AseguradoraDTO> aseguradorasDTO) {
		BuenaCalidadMaterialesBacking.aseguradorasDTO = aseguradorasDTO;
	}
