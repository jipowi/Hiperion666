...
public class RoboAsaltoBacking implements Serializable {
	 ...
	 * <p>
	 * [Author: Franklin Pozo B, Date: 12/04/2016]
	 * </p>
	 * 
		...
		try {
			...
			if (!identificacion.equals("") && ValidatorCedula.getInstancia().validateCedula(identificacion)) {
				...
				if (cliente == null) {
					...
					ramoRoboAsaltoBean.setNombreCliente(cliente.getNombrePersona() + " " + cliente.getApellidoPaterno() + " "
	 ...
	 * <p>
	 * [Author: Framklin Pozo B, Date: 13/04/2016]
	 * </p>
	 * 
	 */
	public void buscarContactoAseguradora() {

		buscarContactoAseguradora(ramoRoboAsaltoBean.getAseguradora());
	}
	...
	public void addAseguradora() {
		...
		try {
			Long idAseguradora = Long.parseLong(ramoRoboAsaltoBean.getAseguradora());
			Aseguradora aseguradoraNew = aseguradoraService.consultarAseguradoraByCodigo(ramoRoboAsaltoBean.getAseguradora());
			...
			AseguradoraDTO aseguradoraDTO = new AseguradoraDTO(detalleCatalogo.getDescDetCatalogo(), aseguradoraNew.getDirecion(),
					...
					ramoRoboAsaltoBean.getContactoAseguradora());
	...
	public static void setAseguradorasDTO(List<AseguradoraDTO> aseguradorasDTO) {
		RoboAsaltoBacking.aseguradorasDTO = aseguradorasDTO;
	}
