...
public class LucroCesanteRoturaMaquinariaBacking implements Serializable {
		...
		try {
			...
			if (!identificacion.equals("") && ValidatorCedula.getInstancia().validateCedula(identificacion)) {
				...
				if (cliente == null) {
					...
					ramoCesanteRoturaMaqBean.setNombreCliente(cliente.getNombrePersona() + " " + cliente.getApellidoPaterno() + " "
	...
	public void buscarContactoAseguradora() {
		...
		buscarContactoAseguradora(ramoCesanteRoturaMaqBean.getAseguradora());
	}
	...
	public void addAseguradora() {
		...
		try {
			Long idAseguradora = Long.parseLong(ramoCesanteRoturaMaqBean.getAseguradora());
			Aseguradora aseguradoraNew = aseguradoraService.consultarAseguradoraByCodigo(ramoCesanteRoturaMaqBean.getAseguradora());
			...
			AseguradoraDTO aseguradoraDTO = new AseguradoraDTO(detalleCatalogo.getDescDetCatalogo(), aseguradoraNew.getDirecion(),
					...
					ramoCesanteRoturaMaqBean.getContactoAseguradora());
	...
	public Poliza setearDatosPoliza() {
		...
		poliza.setRamo(RamoEnum.R15.getLabel());
	...
	public static void setAseguradorasDTO(List<AseguradoraDTO> aseguradorasDTO) {
		LucroCesanteRoturaMaquinariaBacking.aseguradorasDTO = aseguradorasDTO;
	}
